    ...
    render() {
        ...
        return (
            <header
                ...
                className={`site-header-mobile d-flex justify-content-between align-items-center shadow bg-brand ${stickyClassName}`}
            >
                ...
                {mainMenu.length > 0 ? (
                    <div className="w-100 d-flex justify-content-start">
                        <Menu className="position-static">
                            ...
                            >
                                <MenuIcon role="img" aria-hidden focusable="false" style={{ width: 40, height: '1.5rem' }} />
                            </MenuTrigger>
                            <MenuContent
                                tag="nav"
