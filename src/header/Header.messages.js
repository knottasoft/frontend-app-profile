...
const messages = defineMessages({
    ...
    'header.links.about_us': {
        id: 'header.links.about_us',
        defaultMessage: 'About us',
        description: 'Link to the About Us page',
    },
    'header.links.contacts': {
        id: 'header.links.contacts',
        defaultMessage: 'Contacts',
        description: 'Link to the Contacts Page',
    },
    'header.links.help': {
    ...
    'header.input.search.placeholder': {
        id: 'header.input.search.placeholder',
        defaultMessage: 'Search courses',
        description: 'Placeholder for header search input',
    },
