...
import DesktopHeader from './DesktopFooter';
...
function Footer({ intl }) {
    ...
    const mainMenu = [
        ...
        },
        {
            ...
            content: intl.formatMessage(messages['header.links.about_us']),
        },
        {
            type: 'item',
            href: `${config.CONTACTS_URL}`,
            content: intl.formatMessage(messages['header.links.contacts']),
        },
        {
            type: 'item',
